---
title: Carbon - Principles
description: The principles that guide the development of Carbon
---
...
When making decisions, we aim to **optimize for long-term developer productivity**. We take it as a given that everyone wants more features. But in order to quickly provide new features over time, we need to make sure that the platform is easy to use and maintain. This may mean that we have a steeper learning curve in the short term, but it should pay off in the long term.

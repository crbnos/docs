...
description: Learn about the traceability system in Carbon
---
...
- **Tracked Activities** - Transformations or processes that consume inputs and produce outputs (nodes in the graph)
- **Tracked Activity Inputs** - Links activities to their input entities (edges in the graph)
- **Tracked Activity Outputs** - Links activities to their output entities (edges in the graph)

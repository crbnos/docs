---
title: Carbon - Self-Hosting
description: Self-host Carbon on your own infrastructure
---

Single-click self-hosting is coming soon! 

For now, please include the required environment variables found in [env.ts](https://github.com/crbnos/carbon/blob/main/packages/auth/src/config/env.ts), and setup the following infrastructure:
